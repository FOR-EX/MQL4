...
void OnTick() 
{
 ...
 
  {
        ...
        Open[3] < iMA(Symbol(),5,21,0,MODE_SMMA, PRICE_CLOSE,0)  && iMA(Symbol(),0,21,0,MODE_SMMA, PRICE_CLOSE,0) < iMA(Symbol(), 0,50,0,MODE_SMMA, PRICE_CLOSE,0)&&
        iMA(Symbol(),0,50,0,MODE_SMMA, PRICE_CLOSE,0) < iMA(Symbol(), 0,200,0,MODE_SMMA, PRICE_CLOSE,0)&&!orderPlaced
        && ((Hour()== 4)||(Hour()== 10)||(Hour()== 16)))
        ...
        
        {
           ...
           
            {
                ...
                Print("Level 618 is",levelprice1);
                  ...
                  double levelneg13 = NormalizeDouble(span*-.50,Digits);
                ...
                if (IsTradeContextBusy() == false) {
                    ...
                    if (takeprofit < MarketInfo(Symbol(), MODE_STOPLEVEL) * Point)
                     ...
                     // Place the order 
                    double time_expiration = TimeCurrent() + 10 * 60;
                     
                ticket = OrderSend(Symbol(), OP_SELLLIMIT, 10, levelprice1, 3, levelprice2, levelprice3, "My EA", 0,time_expiration, Red);
                orderPlaced = true;
 ...
 
    {
        ...
        if (Close[6]>Open[6] && Close[5]<Open[5] && Close[4]< Open[4] && Close[3] < Open[3] && Close[2] < Open[2] &&
         Close[1] > Open[1] && Open[4] < iMA(Symbol(),5,21,0,MODE_SMMA, PRICE_CLOSE,0)  && iMA(Symbol(),0,21,0,MODE_SMMA, PRICE_CLOSE,0) < iMA(Symbol(), 0,50,0,MODE_SMMA, PRICE_CLOSE,0)&&
        iMA(Symbol(),0,50,0,MODE_SMMA, PRICE_CLOSE,0) < iMA(Symbol(), 0,200,0,MODE_SMMA, PRICE_CLOSE,0)&& !orderPlaced
       && ((Hour()== 4)||(Hour()== 10)||(Hour()== 16)))
        ...
        
        {
            ...
            if(conSec4)
            {
                ...
                Print("Level 618 is",levelprice1B);
                  ...
                  double levelneg13B = NormalizeDouble(spanB*-.50,Digits);
                ...
                if (IsTradeContextBusy() == false) {
                    ...
                    if (takeprofitB < MarketInfo(Symbol(), MODE_STOPLEVEL) * Point)
                     ...
                     double time_expirationB = TimeCurrent() + 10 * 60;
                ticket = OrderSend(Symbol(), OP_SELLLIMIT, 10, levelprice1B, 3, levelprice2B, levelprice3B, "My EA", 0,time_expirationB, Red);
                        orderPlaced = true;
        ...
        if (Close[7]>Open[7] && Close[6]<Open[6] && Close[5]<Open[5] && Close[4]< Open[4] && Close[3] < Open[3] && Close[2] < Open[2] &&
         Close[1] > Open[1] &&  Open[5] < iMA(Symbol(),5,21,0,MODE_SMMA, PRICE_CLOSE,0)  && iMA(Symbol(),0,21,0,MODE_SMMA, PRICE_CLOSE,0) < iMA(Symbol(), 0,50,0,MODE_SMMA, PRICE_CLOSE,0)&&
        iMA(Symbol(),0,50,0,MODE_SMMA, PRICE_CLOSE,0) < iMA(Symbol(), 0,200,0,MODE_SMMA, PRICE_CLOSE,0)&& !orderPlaced
        && ((Hour()== 4)||(Hour()== 10)||(Hour()== 16)))
        ...
        
        {
            ...
            if(conSec5)
            {
                ...
                Print("Level 618 is",levelprice1C);
                  ...
                  double levelneg13C = NormalizeDouble(spanC*-.50,Digits);
                ...
                if (IsTradeContextBusy() == false) {
                    ...
                    if (takeprofitC < MarketInfo(Symbol(), MODE_STOPLEVEL) * Point)
                     ...
                     double time_expirationC = TimeCurrent() + 10 * 60;
                ticket = OrderSend(Symbol(), OP_SELLLIMIT, 10, levelprice1C, 3, levelprice2C, levelprice3C, "My EA", 0,time_expirationC, Red);
                        orderPlaced = true;
        ...
        
        {
            ...
            if(conSec6)
            {
                ...
                Print ("span is", spanD);  
                  ...
                  double level0618D = NormalizeDouble(spanD*.618,Digits);
                ...
                if (IsTradeContextBusy() == false) {
                    ...
                    if (takeprofitD < MarketInfo(Symbol(), MODE_STOPLEVEL) * Point)
                     ...
                     // Place the order 
                    double time_expirationD = TimeCurrent() + 10 * 60;
                     
                ticket = OrderSend(Symbol(), OP_BUYLIMIT, 10, levelprice1D, 3, levelprice2D, levelprice3D, "My EA", 0,time_expirationD, Red);
                orderPlaced = true;
        ...
        
        {
            ...
            if(conSec7)
            {
                ...
                Print ("span is", spanE);  
                  ...
                  double level0618E = NormalizeDouble(spanE*.618,Digits);
                ...
                if (IsTradeContextBusy() == false) {
                    ...
                    if (takeprofitE < MarketInfo(Symbol(), MODE_STOPLEVEL) * Point)
                     ...
                     double time_expirationE = TimeCurrent() + 10 * 60;
                ticket = OrderSend(Symbol(), OP_BUYLIMIT, 10, levelprice1E, 3, levelprice2E, levelprice3E, "My EA", 0,time_expirationE, Red);
                        orderPlaced = true;
        ...
        
        {
            ...
            if(conSec8)
            {
                ...
                Print ("span is", spanF);  
                  ...
                  double level0618F = NormalizeDouble(spanF*.618,Digits);
                ...
                if (IsTradeContextBusy() == false) {
                    ...
                    if (takeprofitF < MarketInfo(Symbol(), MODE_STOPLEVEL) * Point)
                     ...
                     double time_expirationF = TimeCurrent() + 10 * 60;
                ticket = OrderSend(Symbol(), OP_BUYLIMIT, 10, levelprice1F, 3, levelprice2F, levelprice3F, "My EA", 0,time_expirationF, Red);
                        orderPlaced = true;
